...
def mock_api_client():
    ...
    client.create.return_value = {"id": "res-123", "name": "test-vm"}
    client.update.return_value = {"id": "res-123", "name": "test-vm-updated"}
...
class TestDeleteVm:
    ...
    def test_delete_nonexistent(self, mock_api_client):
        ...
        with pytest.raises(Exception, match="404"):
            mock_api_client.delete("vm", "missing")
